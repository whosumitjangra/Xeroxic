 ...
 * [first 5 letters of student email handle] + [2-digit day of month in IST] + [3-digit serial for that day]
 * Example: 'sumit' + '24' + '001' -> 'sumit24001'
 */
async function generateMemorableOrderId(email, date = new Date()) {
  ...
  let prefix = handle.slice(0, 5);
  if (prefix.length < 5) {
    prefix = (prefix + 'print').slice(0, 5);
  }
